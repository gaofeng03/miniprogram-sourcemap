    ...
    rawSourceMap.map((x) => {
      SourceMapConsumer.with(x, null, (consumer) => {
        ...
        if (source.source) {
          ...
          console.log(consumer.sourceContentFor(source.source).substr(source.column, 50));
            this.setState({ sourceContent: consumer.sourceContentFor(source.source)})
        }
